...
const CreateUsr = () => {
    ...
    const { document, documentType, rol, firstLastName, secondLastName,firstName, middleName, departament, city, gender } = person;
        ...
        <div className="content-wrapper">
            <div className="card card-danger">
                <div className="card-header">
                    <h3 className="card-title">Creación De Personas</h3>
                </div>
